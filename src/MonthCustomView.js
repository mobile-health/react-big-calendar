...
class MonthCustomView extends React.Component {
  constructor(...args) {
    super(...args)
...
MonthCustomView.title = (date, { localizer }) =>
  localizer.format(date, 'monthHeaderFormat')

export default MonthCustomView
